...
COMMON_GLOBAL_CFLAGS += -DOMAP_ENHANCEMENT -DOMAP_ENHANCEMENT_CPCAM -DOMAP_ENHANCEMENT_VTC -DUSE_FENCE_SYNC

TARGET_NO_RADIOIMAGE := true
TARGET_BOARD_PLATFORM := k3v2oem1
TARGET_BOOTLOADER_BOARD_NAME := u9508
TARGET_OTA_ASSERT_DEVICE := u9508,U9508,k3v2oem1,k3v2oem
